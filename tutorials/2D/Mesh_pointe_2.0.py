...
Length=0 # Longueur de cette couche 
...
file.write("("+str(L-1)+" "+str(0)+" "+str(2*L)+" "+str(2*L-1)+")\n")
for i in range(0,L-1):
	file.write("("+str(L+i)+" "+str(L+i+1)+" "+str(i+2*(L+1))+" "+str(i+2*(L+1)-1)+")\n")
file.write("("+str(2*L-1)+" "+str(2*L)+" "+str(3*L+1)+" "+str(3*L)+")\n")

for i in range(0,L-1):
	file.write("("+str(i+Gap)+" "+str(i+1+Gap)+" "+str(i+1+L+Gap)+" "+str(i+L+Gap)+")\n")
file.write("("+str(L-1+Gap)+" "+str(0+Gap)+" "+str(2*L+Gap)+" "+str(2*L-1+Gap)+")\n")
for i in range(0,L-1):
	file.write("("+str(L+i+Gap)+" "+str(L+i+1+Gap)+" "+str(i+2*(L+1)+Gap)+" "+str(i+2*(L+1)-1+Gap)+")\n")
file.write("("+str(2*L-1+Gap)+" "+str(2*L+Gap)+" "+str(3*L+1+Gap)+" "+str(3*L+Gap)+")\n")

file.write("(9 14 15 16)\n(39 44 45 46)\n(10 9 16 17)\n(40 39 46 47)\n(19 10 17 18)\n(49 40 47 48)\n(20 11 10 19)\n(50 41 40 49)\n(21 20 11 12)\n(51 50 41 42)\n(22 23 12 21)\n(52 53 42 51)\n(23 12 13 24)\n(53 42 43 54)\n(24 13 26 25)\n(54 43 56 55)\n(13 8 27 26)\n(43 38 57 56)\n(8 0 28 27)\n(38 30 58 57)\n(0 4 29 28)\n(30 34 59 58)\n(4 9 14 29)\n(34 39 44 59)\n);\n}\n);")'''

file.close()

'''
# To help if there is an error
